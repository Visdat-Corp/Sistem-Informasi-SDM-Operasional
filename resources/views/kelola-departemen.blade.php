    ...
    <main class="flex-1 p-8 overflow-y-auto">
        ...
        <div class="flex items-center justify-between mt-8 mb-6">
            ...
            <div class="flex items-center space-x-4">
                <form method="GET" action="{{ route('kelola-departemen') }}" class="flex items-center space-x-4">
                    <div class="relative">
                    ...
                    @if(request('search'))
                        <a href="{{ route('kelola-departemen') }}" class="bg-gray-600 hover:bg-gray-700 text-white font-semibold py-2 px-4 rounded-lg">Reset</a>
                    @endif
                </form>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-md overflow-hidden">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    @empty
                        <tr>
                            <td colspan="3" class="px-6 py-4 text-center text-gray-500">Tidak ada data departemen.
                            </td>
                        </tr>
                    @endforelse
                </tbody>
        ...
        <div id="editModal"
            ...
            <div class="bg-white rounded-2xl shadow-xl w-full max-w-md mx-4">
                ...
                <form class="p-6" method="POST" id="editForm">
                    ...
                    <div class="space-y-4">
                        <div>
                            <label for="editNama" class="block text-sm font-medium text-gray-700 mb-1">Nama Departemen</label>
                            <input type="text" name="nama_departemen" id="editNama"
                                class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500"
                                required>
                        </div>
                    </div>
        ...
        <div id="hapusModal"
            ...
            <div class="bg-white rounded-2xl shadow-xl w-full max-w-sm mx-4">
                <div class="p-8 text-center">
                    ...
                    <p class="text-gray-500 mb-6">Apakah Anda yakin ingin menghapus data departemen ini? Tindakan ini
