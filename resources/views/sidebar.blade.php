...
<aside class="w-64 bg-blue-900 text-blue-100 flex flex-col">
    ...
    <nav class="flex-1 px-4 py-4 space-y-2">
        ...
        <!-- Tautan Jadwal Pengecualian -->
        <a href="/kelola-jadwal-pengecualian" class="flex items-center space-x-3 {{ request()->is('kelola-jadwal-pengecualian*') ? 'bg-blue-950 text-white' : 'hover:bg-blue-800 hover:text-white' }} rounded-lg px-3 py-2.5 transition-colors duration-200">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
